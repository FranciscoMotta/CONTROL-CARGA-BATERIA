 ...
 * Author: Franzua
 *
 * Created on 26 de enero de 2020, 06:26 PM
 */
...
int Dato, Datonplus1 = 0;
ADC_conf();

void main(void) {
    TRIS_LED = 0; //Ponemos el LED como salida 
    LED_1 = 1;
    __delay_ms(1500);
    LED_1 = 0;
    Confi_Blue();
...
SENSA:
        if (ADCON0bits.GO == 1)goto SENSA;
        Tx_num(((ADRESH * 100) / 255)*5);
        __delay_ms(1000);
    }
    return;
}
...
ADC_conf() {
    ADCON0 = 0x01; // Iniciamos con el puerto analogo AN0
